<section id="our-google-clients">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="text-center">Our Clients Love <span>The Results</span> </h2>
                    <div class="google-clients-card">
                        <div class="google-clients-image-wrapper">
                            <img src="../assets/images/google-clients-image.png" alt="">
                        </div>
                        <div class="google-clients-name-heading">
                            <h4>Tim Tetaj,
                                Seal Skin Covers</h4>
                            <hr class="google-hr">
                        </div>
                        <div class="clients-testi-google">
                            <h5><span>
