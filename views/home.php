                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="hero-sec-content">
                                ...
                                <h1> <b>TabSoft Agency’s </b> Digital Marketing Services </h1>
                                <p>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            What digital marketing services does TabSoft Agency offer?
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            TabSoft Agency provides a comprehensive suite of digital marketing services, including Ad
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Can TabSoft Agency help with my business's SEO needs?
                        </button>
                    </h2>
