...
<html lang="en">
<?php
$metaTitle = " Top Email Marketing Services | TabSoft Agency";
...
<body>
                ...
                <div class="col-lg-3">
                    <div class="ads-card">
                        <div class="ad-image-wrapper">
                            <img src="../assets/images/email-marketing-logo-image.png" alt="" style="width: auto !important; height: 80px !important;">
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <p>
                    Tab Soft Agency is a company that helps other businesses grow by using email marketing. We act like an extra part of your team, working closely with your own staff to come up with new ideas and help your business expand. We focus on getting real results and building lasting relationships with our clients.
                    </p>
                    <p>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p>
                    Email marketing offers a unique opportunity to connect with your ideal audience at the perfect time, driving engagement and boosting sales. Partner with Tab Soft Agency to craft goal-oriented email campaigns tailored to your business objectives. Let us help you turn email into your most effective marketing asset.
                    </p>
            ...
            <section id="seo-section">
                ...
                <div class="right-section">
                    <div class="vertical-slider-month">
                        ...
                        <p>
                        At TabSoft Agency, we leverage cutting-edge email marketing technology and ongoing training to provide valuable marketing automation services that drive profitability. Here's how we do email marketing to fuel growth for our clients.
                        </p>
                        <!-- <div class="highlight">
                            <p>
    ...
    <?php $headingTexts = "Find Out How We Achieve Results for Our Clients"; include_once("call-to-action-global.php") ?>
                ...
                <div class="test-slider">
                    <div class="">
                        <div class="testimonial-div">
                            <p class="test-p">
                            "Tab Soft Agency has been instrumental in revamping our email marketing strategy. Their expertise in automation and segmentation has significantly improved our engagement rates and lead generation. We've seen a measurable ROI since partnering with them."  
                            </p>
                    ...
                    <div class="">
                        <div class="testimonial-div">
                            ...
                            "As a small business owner, I was hesitant to invest in email marketing. However, Tab Soft Agency made the process seamless and affordable. Their personalized approach and attention to detail have helped us connect with our customers on a deeper level and drive repeat business."
                            </p>
                            <div class="testimonial-client-section">
                                <div class="testi-image-wrapper">
                    ...
                    <div class="">
                        <div class="testimonial-div">
                            ...
                            "Tab Soft Agency's team is highly skilled and professional. They quickly understood our business needs and developed a tailored email marketing strategy that aligned with our growth objectives. Their reporting and analytics are top-notch, providing us with valuable insights to optimize our campaigns."
                            </p>
                            <div class="testimonial-client-section">
                                <div class="testi-image-wrapper">
                    ...
                    <div class="">
                        <div class="testimonial-div">
                            <p class="test-p">
                            "We were struggling with low conversion rates from our email campaigns. Tab Soft Agency helped us revamp our email templates, improve our messaging, and implement effective A/B testing. The results have been impressive, with a significant increase in click-through and conversion rates."
                            </p>
                            <div class="testimonial-client-section">
                                <div class="testi-image-wrapper">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            What email marketing services does TabSoft Agency offer?
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSix">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How do I get started with TabSoft Agency?
                        </button>
                    </h2>
    ...
    <?php $headingText = "Get Started With Us Today, And Find<br> Your Perfect Solution"; include_once("includes/footer.php") ?>
