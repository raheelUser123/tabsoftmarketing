            ...
            <div class="row seo-category-row">
                <div class="col-lg-4">
                    <ul class="seo-category-li">
                        <li><i class="bi bi-check"></i> Custom Campaign Strategy</li>
                        <li><i class="bi bi-check"></i> Creative Ad Design</li>
                        <li><i class="bi bi-check"></i> Audience Targeting & Segmentation</li>
                        <li><i class="bi bi-check"></i> A/B Testing & Optimization</li>
                        <li><i class="bi bi-check"></i> Real-Time Performance Tracking</li>
                    </ul>
                </div>
                <div class="col-lg-4">
                    <ul class="seo-category-li">
                        <li><i class="bi bi-check"></i> Detailed Analytics & Reporting</li>
                        <li><i class="bi bi-check"></i> Geofilter & Lenses Creation</li>
                        <li><i class="bi bi-check"></i> Influencer Partnerships</li>
                        <li><i class="bi bi-check"></i>Story Ads Management</li>
                        <li><i class="bi bi-check"></i>Snapchat Pixel Setup & Tracking</li>

                    </ul>
                </div>
                <div class="col-lg-4">
                    <ul class="seo-category-li">
                        <li><i class="bi bi-check"></i> Video Ad Production</li>
                        <li><i class="bi bi-check"></i> Retargeting Campaigns</li>
                        <li><i class="bi bi-check"></i> Lead Generation Campaigns</li>
                        <li><i class="bi bi-check"></i> Ad Budget Management</li>
                        <li><i class="bi bi-check"></i> Consulting & Strategy Workshops</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="form-container">
                        ...
                        <form class="animate__animated animate__pulse" id="contact" action="/leads/" method="POST">
                            ...
                            <input type="hidden" name="route" value="snapchat-ads-services/" />
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            How can Snapchat ads help my business?
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            What types of ads can I run on Snapchat?
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How do you target the right audience on Snapchat?
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How do you measure the success of Snapchat ad campaigns?
                        </button>
                    </h2>
