...
<head>
  <title>Tabsoft Agency Secure Payment</title>
   ...
   <div class="main_nav">
    ...
    <div class="about_area inner_bg" style="background-image:url('img/payment_banner.png')">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <p class="inner_title" data-aos="fade-up" data-aos-duration="1000" style="color:white;">Complete Your Payment</p>
                </div>
            </div>
        </div>
    </div>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<p class="card-heading" style="color:black;">Invoice from Tabsoft Agency</p>
						...
						<div class="card-body text-center" style="padding-left:200px;padding-right:200px">
							...
							<p class="card-heading">Credit Or Debit Card </p>
							<div class="row">
								<div class="col-md-6">
